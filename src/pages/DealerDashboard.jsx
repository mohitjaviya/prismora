...
export default function DealerDashboard() {
  ...
  const kpiCards = [
    { label: 'Outstanding', value: formatCurrency(dealer.outstandingAmount || 0), icon: <Wallet size={22} className="text-rose-400" />, sub: `${utilizationPct}% of ${formatCurrency(dealer.creditLimit)} limit` },
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        <h1 className="text-2xl font-bold text-white">Welcome back, {dealer.name}</h1>
