...
export default function DistributorDashboard() {
  ...
  const kpiCards = [
    { label: 'Outstanding', tone: 'danger', value: formatCurrency(distributor.outstandingAmount || 0), icon: Wallet, sub: `${utilizationPct}% of ${formatCurrency(distributor.creditLimit)} limit` },
