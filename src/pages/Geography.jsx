        ...
        <div className="fixed inset-0 z-[200] flex items-start justify-center p-4 pt-[8vh]">
          ...
          <div className="relative glass-panel bg-brand-primary w-full max-w-lg max-h-[90vh] rounded-2xl shadow-2xl border border-brand-accent/30 animate-fade-in-up z-10 flex flex-col overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-4">
              <div>
                <label htmlFor="geography-territory-zone-name" className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wide">Territory/Zone Name *</label>
                <input id="geography-territory-zone-name" 
                  type="text" 
                  required
              ...
              <div>
                <label htmlFor="geography-state-coverage" className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wide">State Coverage *</label>
                <select id="geography-state-coverage"
              ...
              <div>
                <label htmlFor="geography-assigned-sales-supervisor" className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wide">Assigned Sales Supervisor *</label>
                <select id="geography-assigned-sales-supervisor"
