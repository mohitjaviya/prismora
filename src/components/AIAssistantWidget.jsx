...
const AIAssistantWidget = ({ onClose }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[380px] max-w-[calc(100vw-2rem)] h-[560px] max-h-[calc(100vh-6rem)] z-[100] glass-panel bg-brand-primary/95 rounded-2xl shadow-2xl flex flex-col gap-3 p-4 animate-fade-in-up border border-brand-accent/30 overflow-hidden">
      {/* Header */}
