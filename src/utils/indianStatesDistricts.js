export const STATE_DISTRICTS = {
  "Andhra Pradesh": [
    ...
    "West Godavari", "Anakapalli", "Kona Seema", "Eluru", "NTR", "Bapatla", 
    "Palnadu", "Nandyal", "Sri Sathya Sai", "Parvathipuram Manyam", 
    "Alluri Sitharama Raju", "Tirupati", "Annamayya"
  ],
  "Arunachal Pradesh": [
  ...
  "Chhattisgarh": [
    ...
    "Rajnandgaon", "Sukma", "Surajpur", "Surguja", "Manendragarh-Chirmiri-Bharatpur", 
  ...
  "Madhya Pradesh": [
    ...
    "Ujjain", "Umaria", "Vidisha", "Mauganj", "Maihar", "Chachoura"
  ],
  "Maharashtra": [
  ...
  "Punjab": [
    ...
    "SAS Nagar (Mohali)", "Sangrur", "SBS Nagar", "Tarn Taran"
  ],
  "Rajasthan": [
    ...
    "Balotra", "Beawar", "Anupgarh", "Didwana-Kuchaman", "Deeg", "Dudu", 
